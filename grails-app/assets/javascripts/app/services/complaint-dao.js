/**
 * Service that provides CRUD operations for Complaint.
 */
angular.module('nmr.services.dao.complaint', ['ngResource', 'nmr.constants', 'nmr.services.dao']).factory('Complaint', ['$resource', '$http', 'CONTEXT_PREFIX', function($resource, $http, CONTEXT_PREFIX) {
	
	var urlPatternPrefix = CONTEXT_PREFIX + '/rest/complaint';
	var dateFields = ['onsetDate'];
